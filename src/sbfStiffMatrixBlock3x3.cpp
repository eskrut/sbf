...
sbfStiffMatrixBlock3x3::sbfStiffMatrixBlock3x3(sbfMesh *mesh, sbfPropertiesSet *propSet, MatrixType type) :
...
void sbfStiffMatrixBlock3x3::updateIndexesFromMesh(int *begin, int *end)
{
...
void sbfStiffMatrixBlock3x3::updateIndexesFromMesh(int startElemIndex, int stopElemIndex)
{
...
void sbfStiffMatrixBlock3x3::updateIndexesFromMesh()
{
...
sbfMatrixIterator *sbfStiffMatrixBlock3x3::createIterator() /*const*/
{
    return new sbfStiffMatrixBlock3x3Iterator(this);
}

void sbfStiffMatrixBlock3x3::compute(int startID, int stopID)
{
...
sbfStiffMatrix *sbfStiffMatrixBlock3x3::createIncompleteChol()
{
    sbfStiffMatrixBlock3x3 *cholFactor = new sbfStiffMatrixBlock3x3(mesh_, nullptr, MatrixType::DOWN_TREANGLE_MATRIX | MatrixType::INCOMPLETE_CHOL);
...
void sbfStiffMatrixBlock3x3::solve_L_LT_u_eq_f(double *u, double *f, sbfMatrixIterator *iterator)
{
...
bool sbfStiffMatrixBlock3x3::isValid()
{
...
void sbfStiffMatrixBlock3x3::read_stream(std::ifstream &in)
{
...
void sbfStiffMatrixBlock3x3::write_stream(std::ofstream &out) const
{
